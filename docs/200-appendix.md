...
#> Rows: 580
#> Columns: 7
#> $ rid       <fct> av-adapt1-M-f-CC, av-adapt1-M-f-DB, av-a~
#> $ sid       <fct> M-f-CC, M-f-DB, M-f-HG, M-f-JM, M-f-MS, ~
#> $ task      <fct> audiovisual, audiovisual, audiovisual, a~
#> $ block     <fct> adapt1, adapt1, adapt1, adapt1, adapt1, ~
#> $ age_group <fct> middle, middle, middle, middle, middle, ~
