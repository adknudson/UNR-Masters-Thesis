...
#> Rows: 580
#> Columns: 8
#> $ rid       <fct> av-post1-M-f-CC, av-post1-M-f-DB, av-pos~
#> $ sid       <fct> M-f-CC, M-f-DB, M-f-HG, M-f-JM, M-f-MS, ~
#> $ path      <chr> "Audiovisual/MiddleAge/CC/CCadapt1__MAT.~
#> $ task      <chr> "audiovisual", "audiovisual", "audiovisu~
#> $ trial     <fct> post1, post1, post1, post1, post1, post1~
#> $ age_group <fct> middle_age, middle_age, middle_age, midd~
#> $ age       <dbl> 39, 44, 41, 48, 49, 43, 47, 49, 49, 44, ~
#> $ sex       <fct> F, F, F, F, F, F, F, F, F, M, M, M, M, M~
```
\setstretch{2.0}
