...
#> 
#> Tree depth:
#> 5 of 4000 iterations saturated the maximum tree depth of 10 (0.125%).
...
Model & elpd\_diff & se\_diff & elpd\_loo & p\_loo & se\_p\_loo\\
\midrule
With Subjects & 0.00 & 0.00 & -924.9 & 75.31 & 5.418\\
Without Subjects & -76.23 & 19.23 & -1001.1 & 19.27 & 1.908\\
\bottomrule
\end{tabular}
\end{table}
